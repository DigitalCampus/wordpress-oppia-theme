	...
	<div id="wrapper">
		...
		<div id="header">
			...
			<div id="logo">
				...
				<img src="<?php bloginfo('template_url'); ?>/images/oppia-logo.png" alt="<?php bloginfo('title'); ?> - <?php bloginfo('description'); ?>" title="<?php bloginfo('title'); ?> - <?php bloginfo('description'); ?>"/>
				</a>
			</div>
			<div id="tagline">
				by <a href="http://digital-campus.org">Digital Campus</a>
			</div>
